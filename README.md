...
For details of the mappings in CSV format, see the [service guide](https://developer.service.hmrc.gov.uk/guides/income-tax-mtd-end-to-end-service-guide/#mapping-apis-to-self-assessment-tax-return-forms).
